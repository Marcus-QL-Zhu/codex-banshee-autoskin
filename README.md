...
This fork adds an artless dark structural pack while preserving the official Codex renderer and native controls. It uses abstract blue-black armor planes, cut panel seams, recessed structures, and one synchronized 20-second energy cycle. It contains no character, machine, emblem, or official franchise artwork. The engine-extension requirements and acceptance gates are documented in [BANSHEE-SPEC.md](BANSHEE-SPEC.md).
