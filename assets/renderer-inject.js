  ...
  const syncThemeMeta = () => {
    ...
    if (pack === "banshee") {
      if (chrome.dataset.dreamPack !== "banshee") {
        chrome.innerHTML = '<div class="dream-banshee-frame"></div><i class="dream-banshee-rail dream-banshee-rail-top"></i><i class="dream-banshee-rail dream-banshee-rail-bottom"></i>';
      }
